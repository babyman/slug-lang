...
[ADR-025](/adr/adr-025) establishes `select` as an expression composed of cases, each producing a *case value* that is
passed into an explicit body via the `/>` operator.
...
* Makes [ADR-025](/adr/adr-025) case values directly observable and usable
